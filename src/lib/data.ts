...
export const categories: Category[] = [
  ...
  },
  {
    ...
    context: [
      ...
      "אורך הוויטרינה נקבע לפי מגוון המוצרים וקצב המכירה, והעומק לפי המקום שיש מאחורי הדלפק. ספרו לנו על החלל ונחזור עם המלצה.",
    ],
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    text: "תצוגה מעל דלפק לבשר ולקצבייה, בגובה ובעומק שמתאימים לעבודה מאחורי הדלפק.",
    equipment: "מעדניות",
    client: "נתח קצבים",
    location: "מרכז",
    image: "/projects/deli-vitrine.jpg",
...
export const processSteps = [
  { title: "אפיון", placeholder: "אפיון העסק והחלל", ratio: "4 / 5" },
